...
export const SidebarItems = ({title, href, icon, selected, notifications}: Props) => {
    return <li className="cursor-pointer my-[5px]">
        <Link className={cn('flex items-center justify-between group rounded-lg hover:bg-[#1D1D1D]', selected ? 'bg-[#1D1D1D]' : '')} href={href}>
