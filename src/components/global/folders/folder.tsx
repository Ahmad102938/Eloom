...
import { renameFolders } from '@/action/workspace'
    ...
    return <div 
        ...
        <Loader state={false}>
            <div className='flex flex-col gap-[1px]'>
                {onRename ? (<Input onBlur={(e: React.FocusEvent<HTMLInputElement>) => {
                updateFolderName(e)
              }} autoFocus placeholder={name} className='border-none text-base w-full outline-none text-neutral-300 bg-transparent p-0' ref={inputRef}/>) : (<p onClick={(e) => e.stopPropagation()} onDoubleClick={handleNameDoubleClick} className='text-neutral-300'>
